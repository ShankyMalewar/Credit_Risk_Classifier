...
def main():
    ...
    with mlflow.start_run(run_name="Ensemble"):
        ...
        with torch.no_grad():
            ann_input = torch.tensor(X_test, dtype=torch.float32).to(device)
